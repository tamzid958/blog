                ...
                <div class='row no-gutters'>
                    ...
                    <div class='col-md-8'>
                        <div class='card-body text-dark'>
                            ...
                            <a href='edit_post/" . $post["post_slug"] . "' type='button' class='btn btn-success btn-sm' id=" . $post["post_id"] . ">Edit</a>
                            <a href='comments/?id=" . $post["post_id"] . "' type='button'  class='btn btn-info btn-sm check-cmnt'>Check Comments</a>
